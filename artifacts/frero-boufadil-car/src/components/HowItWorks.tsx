        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          <div className="hidden md:block absolute top-12 left-[16.67%] right-[16.67%] h-px z-0">
            <motion.div
              className="h-full"
              style={{
                backgroundImage: "repeating-linear-gradient(90deg, #C8A96E40 0, #C8A96E40 8px, transparent 8px, transparent 16px)",
            ...
            return (
              ...
              >
                <div className="relative mb-6">
                  <div className="w-24 h-24 rounded-full bg-[var(--c-bg-card)] border-2 border-[#C8A96E]/30 flex items-center justify-center shadow-lg">
                ...
                <h3 className="font-['Syne'] font-bold text-xl text-[var(--c-text-primary)] mb-3">
                  {t(step.titleKey)}
                </h3>
